...
UPSTREAM_REPO="https://github.com/MiSTer-devel/EG2000_MiSTer.git"
CORE_NAME=(eg2000)
...
UPSTREAM_CORE_NAME=(eg2000)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(eg2000.qpf)
COMPILATION_OUTPUT=(output_files/eg2000.rbf)
